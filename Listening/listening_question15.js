...
const question15Data_13 = {
  audioUrl: "audio/question15/2026_T6/01_aptisfree_com_children_technology.mp3", // Đường dẫn đến file audio
...
Woman: That may be true, but I also believe children can learn to control their own online behaviour. With proper education, they can understand when to stop using technology and how to interact responsibly online.`,
  ...
  correctAnswer: ["Both", "Both", "Man", "Woman"] // Đáp án đúng của từng câu hỏi
};

// Dữ liệu câu hỏi 15
const question15Data_14 = {
  audioUrl: "audio/question15/2026_T6/02_environmental_volunteer_program.mp3", // Đường dẫn đến file audio
...
Man: Education helps, but without fines or punishment, many people will not change their behavior.`,
  ...
  correctAnswer: ["Both", "Man", "Woman", "Man"] // Đáp án đúng của từng câu hỏi
};

// Dữ liệu câu hỏi 15
const question15Data_15 = {
  audioUrl: "audio/question15/2026_T6/03_local_culture_differences.mp3", // Đường dẫn đến file audio
...
const question15Data_16 = {
  audioUrl: "", // Đường dẫn đến file audio
...
const question15Data = [
  ...
  question15Data_13, question15Data_14, question15Data_15, question15Data_16, question15Data_17
];
